...
{
    public class SoundDownloadAudioFilePlugin : SoundDownloadPlugin
    {
        public SoundDownloadAudioFilePlugin(string url) : base(url) { }
        ...
        public override async Task<SoundDownloadPluginResult> GetResult()
        {
            ...
            return new SoundDownloadAudioFilePluginResult(
                audioFileName,
                audioFileType,
                fileSize
            );
