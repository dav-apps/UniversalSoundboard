    ...
    public partial class InAppNotification : ContentControl
    {
        ...
        protected override void OnApplyTemplate()
        {
            ...
            if (_dismissButton != null)
            {
                ...
                _dismissButton.Click += DismissButton_Click;
                AutomationProperties.SetName(_dismissButton, Windows.ApplicationModel.Resources.ResourceLoader.GetForViewIndependentUse("UniversalSoundboard.Compatibility/Resources").GetString("WCT_InAppNotification_DismissButton_AutomationName"));
            }
