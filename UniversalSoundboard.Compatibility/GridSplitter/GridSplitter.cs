...
namespace Microsoft.Toolkit.Uwp.UI.Controls
{
    ...
    public partial class GridSplitter : Control
    {
        ...
        public GridSplitter()
        {
            ...
            string automationName = Windows.ApplicationModel.Resources.ResourceLoader.GetForViewIndependentUse("UniversalSoundboard.Compatibility/Resources").GetString("WCT_GridSplitter_AutomationName");
